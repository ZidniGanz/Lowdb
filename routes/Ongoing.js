...
router.get('/:page', async (req, res) => {
    ...
    let fullUrl = url.baseURL + url.ONGOING_ENDPOINT + page
    ...
    if (page === '1'){
        ...
        nextUrl = req.protocol + '://' + req.get('host') + '/api/anime/ongoing/' + next
    } else {
        next = parseInt(page) + 1
        prev = parseInt(page) - 1
        nextUrl = req.protocol + '://' + req.get('host') + '/api/anime/ongoing/' + next
        prevUrl = req.protocol + '://' + req.get('host') + '/api/anime/ongoing/' + prev
    }
